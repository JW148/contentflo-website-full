...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[1000px] md:min-h-[200vh] flex flex-col items-center -mt-20 md:mt-0 md:pt-20 mb-10 justify-start  shrink-0 [perspective:800px] transform md:scale-100  scale-[0.55] sm:scale-50 "
    >
      <motion.h2
        style={{
